...
| Store | File |
|---|---|
| Chrome Web Store | `.output/hdrezka-speeds-0.6.2-chrome.zip` |
| Firefox AMO (extension) | `.output/hdrezka-speeds-0.6.2-firefox.zip` |
| Firefox AMO (sources) | `.output/hdrezka-speeds-0.6.2-sources.zip` |
