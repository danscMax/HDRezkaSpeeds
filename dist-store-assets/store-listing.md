...
| Store | File |
|---|---|
| Chrome Web Store | `.output/hdrezka-speeds-0.6.5-chrome.zip` |
| Firefox AMO (extension) | `.output/hdrezka-speeds-0.6.5-firefox.zip` |
| Firefox AMO (sources) | `.output/hdrezka-speeds-0.6.5-sources.zip` |
