 ...
 */
const REVIEW_URLS = {
  amo: 'https://addons.mozilla.org/firefox/addon/hdrezka-speed-controller/reviews/',
  chrome: 'https://chromewebstore.google.com/detail/bledompcjiepahghecekpeodipnpbhpl/reviews',
};
