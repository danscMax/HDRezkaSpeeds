...
export const I18N_DICT = {
  en: {
    ...
    'panel.channel.aria_on': 'This film has its own speed — press to clear',
    'panel.channel.aria_off': 'Save this speed for this film',
    'panel.channel.tooltip_on': 'This film plays at {speed}×. Press to clear it.',
    'panel.channel.tooltip_off': 'Save the current speed for this film',
    'panel.channel.tooltip_unknown': 'The film is not identified yet',
    'toast.channel_saved': 'Saved {speed}× for this film',
    'toast.channel_forgotten': 'This film no longer has its own speed',
    'toast.channel_unknown': 'The film is not identified yet — try again in a moment',
    ...
    'diag.memory.off': 'Per-title memory is off.',
    'diag.memory.key': 'Title: {key}',
    'diag.memory.no_key': 'Title: not identified',
    ...
    // FEAT-018: resume ("continue where you left off") chip + shared
    // action-chip button labels. resume.chip's {time} is M:SS / H:MM:SS.
    'resume.chip': 'Continue from {time}',
    'chip.reload': 'Reload',
    ...
    'behavior.dim_screens.spoofed':
      'Your browser is hiding the real size of your monitors from extensions (anti-fingerprinting), so they cannot be found. Turn that protection off for this site, or leave this feature off.',
  ...
  ru: {
    ...
    'panel.channel.aria_on': 'У этого фильма своя скорость — нажмите, чтобы снять',
    'panel.channel.aria_off': 'Сохранить эту скорость для этого фильма',
    'panel.channel.tooltip_on': 'Этот фильм идёт на {speed}×. Нажмите, чтобы снять.',
    'panel.channel.tooltip_off': 'Сохранить текущую скорость для этого фильма',
    'panel.channel.tooltip_unknown': 'Фильм пока не определён',
    'toast.channel_saved': 'Для этого фильма сохранено {speed}×',
    'toast.channel_forgotten': 'У этого фильма больше нет своей скорости',
    'toast.channel_unknown': 'Фильм пока не определён — попробуйте через секунду',
    ...
    'diag.memory.off': 'Память по фильмам выключена.',
    'diag.memory.key': 'Фильм: {key}',
    'diag.memory.no_key': 'Фильм: не определён',
    ...
    // FEAT-018: resume-чип + подписи кнопок action-чипа.
    ...
    'behavior.dim_screens.spoofed':
      'Браузер скрывает от расширений настоящий размер мониторов (защита от отслеживания), поэтому найти их нельзя. Отключите эту защиту для сайта либо не включайте затемнение.',
    'behavior.dim_screens.no_player_screen':
